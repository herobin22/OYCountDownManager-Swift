...
class OYSingleTableVC: UIViewController {
    ...
    private func setupUI() {
        ...
        self.tableView.register(OYTableViewCell.classForCoder(), forCellReuseIdentifier: OYTableViewCellID)
        self.tableView.refreshControl = UIRefreshControl()
        self.tableView.refreshControl?.addTarget(self, action: #selector(OYSingleTableVC.reloadData), for: .valueChanged)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.countDownZero = {
            ...
            if !timeOutModel.timeOut{
                print("SingleTableVC--%@--时间到了", timeOutModel.title!)
            }
